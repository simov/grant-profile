...
var before = {
  ...
  basecamp: (data) => ({headers: {'user-agent': 'simov/grant'}}),
  dailymile: (data) => ({qs: {oauth_token: data.access_token}}),
  ...
  instagram: (data) => ({qs: {access_token: data.access_token}}),
  ...
  twitch: (data) => ({headers: {authorization: `OAuth ${data.access_token}`}}),
